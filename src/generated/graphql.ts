...
export type TitleRecord = {
  ...
  _allSubheadingLocales?: Maybe<Array<Maybe<StringMultiLocaleField>>>;
  ...
  titlePicture?: Maybe<FileField>;
  updatedAt: Scalars['DateTime'];
};


/** Record of type Title (title) */
export type TitleRecord_AllSubheadingLocalesArgs = {
  locale?: Maybe<SiteLocale>;
};


/** Record of type Title (title) */
export type TitleRecord_AllTitleLocalesArgs = {
  locale?: Maybe<SiteLocale>;
};
...
/** Record of type Title (title) */
export type TitleRecordSubheadingArgs = {
  locale?: Maybe<SiteLocale>;
};


/** Record of type Title (title) */
export type TitleRecordTitleArgs = {
  locale?: Maybe<SiteLocale>;
};
...
export type GetTitleQuery = (
  ...
  & { title?: Maybe<(
    { __typename?: 'TitleRecord' }
    & Pick<TitleRecord, 'title' | 'subheading'>
    & { titlePicture?: Maybe<(
      { __typename?: 'FileField' }
      & Pick<FileField, 'url'>
